...
namespace MediaInfoDotNet.Models
{
	...
	public sealed class VideoStream : Media
	{
		...
		/// <summary>Smart frame rate detection of the stream in frames per second.</summary>
		...
		public bool isInterlace { get { return String.Equals(streamCommon.scanType, "Interlaced", StringComparison.OrdinalIgnoreCase) ? true : false; } }

		/// <summary>Return true if video was Top Field First otherwise Bottom Field First</summary>
		public bool isTopFieldFirst { get { return String.Equals(streamCommon.scanOrder, "TFF", StringComparison.OrdinalIgnoreCase) ? true : false; } }
